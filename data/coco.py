...
class COCODataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self, B=None):
        if B is None:
            B=self.batch_size 
        return torch.utils.data.DataLoader(self.train, batch_size=B, shuffle=True, num_workers=8, collate_fn=collate_fn, prefetch_factor=4, pin_memory=True,drop_last=True)
